...
/**
 * AUTO-GENERATED FILE @ 2020-07-09 08:43:03 - DO NOT EDIT!
 *
 * This file was automatically generated by schemats v.3.0.3
 * $ schemats generate -c postgres://username:password@localhost/postgres -t contribution -t transfer -t application_session -t rollover -t interested_party -t validated_pages -t initial_investment -t payment -t applicant -t beneficiary -t body -t fee_arrangement -t custodians -s salesforce
 *
 */
...
export namespace transferFields {
    ...
    export type institution_id = string | null;
...
export interface transfer {
    ...
    institution_id: transferFields.institution_id;
...
export interface application_session {
    ...
    heroku_token: application_sessionFields.heroku_token;
...
export namespace custodiansFields {
    export type name = string | null;
    export type phone = string | null;
    export type billing_street = string | null;
    export type billing_city = string | null;
    export type billing_state = string | null;
    export type billing_zip = string | null;
    export type salesforce_id = string;

}

export interface custodians {
    name: custodiansFields.name;
    phone: custodiansFields.phone;
    billing_street: custodiansFields.billing_street;
    billing_city: custodiansFields.billing_city;
    billing_state: custodiansFields.billing_state;
    billing_zip: custodiansFields.billing_zip;
    salesforce_id: custodiansFields.salesforce_id;
