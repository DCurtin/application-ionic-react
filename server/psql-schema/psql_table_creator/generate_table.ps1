...
function import-tables{
    ...
    $script | Out-File -FilePath "$path/create_tables.psql" -Encoding utf8NoBOM

    #$Utf8NoBomEncoding = New-Object System.Text.UTF8Encoding $False
    #[System.IO.File]::WriteAllLines("./create_tables.psql", $script, $Utf8NoBomEncoding)
}

import-tables -path $path